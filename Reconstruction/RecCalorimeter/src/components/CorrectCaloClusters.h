...
private:
   ...
   * @return                  Status code.
   */
  StatusCode applyUpstreamCorr(const fcc::CaloClusterCollection* inClusters,
   ...
   * @return                  Status code.
   */
  StatusCode applyDownstreamCorr(const fcc::CaloClusterCollection* inClusters,
                                 fcc::CaloClusterCollection* outClusters);
   ...
   */
  double getEnergyInLayer(const fcc::CaloCluster& cluster,
   ...
   */
  double getClusterTheta(const fcc::CaloCluster& cluster);
